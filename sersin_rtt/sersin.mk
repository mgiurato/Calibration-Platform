...
# Autogenerated on: 15-Sep-2015 11:48:57
# Model: SERSIN
# MyTemplate
# File name: sersin.mk
# Template: gmake 
...
MATLAB_ROOT_RELATIVE := ../../../../../../usr/local/MATLAB/R2015a/#MATLAB_ROOT_RELATIVE_END
MATLAB_ROOT_ABSOLUTE := /usr/local/MATLAB/R2015a/#MATLAB_ROOT_ABSOLUTE_END
...
ifneq (.a,$(strip $(TARGET_EXT)))
SOURCE_FILES := $(call FORMAT_PATH,./ert_main.c) $(call FORMAT_PATH,./rtGetInf.c) $(call FORMAT_PATH,./rtGetNaN.c) $(call FORMAT_PATH,./rt_nonfinite.c) $(call FORMAT_PATH,./sersin.c) $(call FORMAT_PATH,./sersin_data.c) $(call FORMAT_PATH,./HardwareSerial.cpp) $(call FORMAT_PATH,./IPAddress.cpp) $(call FORMAT_PATH,./Print.cpp) $(call FORMAT_PATH,./WInterrupts.c) $(call FORMAT_PATH,./WMath.cpp) $(call FORMAT_PATH,./WString.cpp) $(call FORMAT_PATH,./new.cpp) $(call FORMAT_PATH,./wiring.c) $(call FORMAT_PATH,./wiring_analog.c) $(call FORMAT_PATH,./wiring_digital.c) $(call FORMAT_PATH,./Servo.cpp) $(call FORMAT_PATH,./io_wrappers.cpp)
else
SOURCE_FILES := $(call FORMAT_PATH,./ert_main.c) $(call FORMAT_PATH,./rtGetInf.c) $(call FORMAT_PATH,./rtGetNaN.c) $(call FORMAT_PATH,./rt_nonfinite.c) $(call FORMAT_PATH,./sersin.c) $(call FORMAT_PATH,./sersin_data.c) $(call FORMAT_PATH,./HardwareSerial.cpp) $(call FORMAT_PATH,./IPAddress.cpp) $(call FORMAT_PATH,./Print.cpp) $(call FORMAT_PATH,./WInterrupts.c) $(call FORMAT_PATH,./WMath.cpp) $(call FORMAT_PATH,./WString.cpp) $(call FORMAT_PATH,./new.cpp) $(call FORMAT_PATH,./wiring.c) $(call FORMAT_PATH,./wiring_analog.c) $(call FORMAT_PATH,./wiring_digital.c) $(call FORMAT_PATH,./Servo.cpp) $(call FORMAT_PATH,./io_wrappers.cpp)
endif

HEADER_FILES := $(call FORMAT_PATH,./rtGetInf.h) $(call FORMAT_PATH,./rtGetNaN.h) $(call FORMAT_PATH,./rt_nonfinite.h) $(call FORMAT_PATH,./sersin.h) $(call FORMAT_PATH,../../SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/cores/arduino/HardwareSerial.h) $(call FORMAT_PATH,../../SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/cores/arduino/IPAddress.h) $(call FORMAT_PATH,../../SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/cores/arduino/Print.h) $(call FORMAT_PATH,../../SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/cores/arduino/WString.h) $(call FORMAT_PATH,../../SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/cores/arduino/new.h) $(call FORMAT_PATH,../../SupportPackages/R2015a/arduino-1.0.5/libraries/Servo/Servo.h)
...
COMPILER_CODEGEN_ARGS := -I"/home/pela/Documents/MATLAB/SupportPackages/R2015a/arduinobase/toolbox/realtime/targets/arduino/include" -I"/home/pela/Documents/MATLAB/SupportPackages/R2015a/arduinobase/toolbox/realtime/targets/arduino/blocks/sfcn/include" -I"/home/pela/Documents/MATLAB/SupportPackages/R2015a/arduino-1.0.5/libraries/Servo" -I"/home/pela/Documents/MATLAB/Calibration-Platform/sersin_rtt" -I"/home/pela/Documents/MATLAB/Calibration-Platform" -I"/usr/local/MATLAB/R2015a/extern/include" -I"/usr/local/MATLAB/R2015a/simulink/include" -I"/usr/local/MATLAB/R2015a/rtw/c/src" -I"/usr/local/MATLAB/R2015a/rtw/c/src/ext_mode/common" -I"/usr/local/MATLAB/R2015a/rtw/c/ert" -I"/home/pela/Documents/MATLAB/SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/cores/arduino" -I"/home/pela/Documents/MATLAB/SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/variants/standard" -mmcu=atmega328p -ffunction-sections -fdata-sections -std=gnu99 -Wall -Wstrict-prototypes -g -Os -D"MODEL=sersin" -D"NUMST=2" -D"NCSTATES=0" -D"HAVESTDIO=" -D"UNIX=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=1" -D"F_CPU=16000000" -D"ARDUINO=105" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"_RTT_NUMSERVOS_=3"
...
POSTBUILD_ARGS := -O ihex -R .eeprom $(TARGET)  sersin.hex

EXECUTE_ARGS := 



COMPILER ?= $(subst \,/,/home/pela/Documents/MATLAB/SupportPackages/R2015a/arduino-1.0.5/hardware/tools/avr/bin/avr-gcc)

LINKER ?= $(subst \,/,/home/pela/Documents/MATLAB/SupportPackages/R2015a/arduino-1.0.5/hardware/tools/avr/bin/avr-gcc)

PREBUILD_TOOL ?= 

POSTBUILD_TOOL ?= $(subst \,/,/home/pela/Documents/MATLAB/SupportPackages/R2015a/arduino-1.0.5/hardware/tools/avr/bin/avr-objcopy)
