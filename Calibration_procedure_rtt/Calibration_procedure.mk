...
# Autogenerated on: 17-Feb-2016 12:44:37
# Model: CALIBRATION_PROCEDURE
# MyTemplate
# File name: Calibration_procedure.mk
# Template: gmake 
...
MODEL_NAME := Calibration_procedure
...
MATLAB_ROOT_RELATIVE := ..\..\..\..\..\..\Program Files\MATLAB\R2015aSP1\#MATLAB_ROOT_RELATIVE_END
MATLAB_ROOT_ABSOLUTE := C:\Program Files\MATLAB\R2015aSP1\#MATLAB_ROOT_ABSOLUTE_END
...
ifneq (.a,$(strip $(TARGET_EXT)))
SOURCE_FILES := $(call FORMAT_PATH,.\HardwareSerial.cpp) $(call FORMAT_PATH,.\IPAddress.cpp) $(call FORMAT_PATH,.\Print.cpp) $(call FORMAT_PATH,.\WInterrupts.c) $(call FORMAT_PATH,.\WMath.cpp) $(call FORMAT_PATH,.\WString.cpp) $(call FORMAT_PATH,.\new.cpp) $(call FORMAT_PATH,.\wiring.c) $(call FORMAT_PATH,.\wiring_analog.c) $(call FORMAT_PATH,.\wiring_digital.c) $(call FORMAT_PATH,.\Servo.cpp) $(call FORMAT_PATH,.\io_wrappers.cpp) $(call FORMAT_PATH,.\Calibration_procedure.c) $(call FORMAT_PATH,.\Calibration_procedure_data.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\rtGetInf.c) $(call FORMAT_PATH,.\rtGetNaN.c) $(call FORMAT_PATH,.\rt_nonfinite.c)
else
SOURCE_FILES := $(call FORMAT_PATH,.\HardwareSerial.cpp) $(call FORMAT_PATH,.\IPAddress.cpp) $(call FORMAT_PATH,.\Print.cpp) $(call FORMAT_PATH,.\WInterrupts.c) $(call FORMAT_PATH,.\WMath.cpp) $(call FORMAT_PATH,.\WString.cpp) $(call FORMAT_PATH,.\new.cpp) $(call FORMAT_PATH,.\wiring.c) $(call FORMAT_PATH,.\wiring_analog.c) $(call FORMAT_PATH,.\wiring_digital.c) $(call FORMAT_PATH,.\Servo.cpp) $(call FORMAT_PATH,.\io_wrappers.cpp) $(call FORMAT_PATH,.\Calibration_procedure.c) $(call FORMAT_PATH,.\Calibration_procedure_data.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\rtGetInf.c) $(call FORMAT_PATH,.\rtGetNaN.c) $(call FORMAT_PATH,.\rt_nonfinite.c)
endif

HEADER_FILES := $(call FORMAT_PATH,..\..\..\..\..\..\MATLAB\SupportPackages\R2015aSP1\arduino-1.0.5\hardware\arduino\cores\arduino\HardwareSerial.h) $(call FORMAT_PATH,..\..\..\..\..\..\MATLAB\SupportPackages\R2015aSP1\arduino-1.0.5\hardware\arduino\cores\arduino\IPAddress.h) $(call FORMAT_PATH,..\..\..\..\..\..\MATLAB\SupportPackages\R2015aSP1\arduino-1.0.5\hardware\arduino\cores\arduino\Print.h) $(call FORMAT_PATH,..\..\..\..\..\..\MATLAB\SupportPackages\R2015aSP1\arduino-1.0.5\hardware\arduino\cores\arduino\WString.h) $(call FORMAT_PATH,..\..\..\..\..\..\MATLAB\SupportPackages\R2015aSP1\arduino-1.0.5\hardware\arduino\cores\arduino\new.h) $(call FORMAT_PATH,..\..\..\..\..\..\MATLAB\SupportPackages\R2015aSP1\arduino-1.0.5\libraries\Servo\Servo.h) $(call FORMAT_PATH,.\Calibration_procedure.h) $(call FORMAT_PATH,.\rtGetInf.h) $(call FORMAT_PATH,.\rtGetNaN.h) $(call FORMAT_PATH,.\rt_nonfinite.h)
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2015aSP1/arduinobase/toolbox/realtime/targets/arduino/include" -I"C:/MATLAB/SupportPackages/R2015aSP1/arduinobase/toolbox/realtime/targets/arduino/blocks/sfcn/include" -I"C:/MATLAB/SupportPackages/R2015aSP1/arduino-1.0.5/libraries/Servo" -I"C:/Users/Mattia/Documents/MATLAB/Calibration-Platform/Calibration_procedure_rtt" -I"C:/Users/Mattia/Documents/MATLAB/Calibration-Platform" -I"C:/Program Files/MATLAB/R2015aSP1/extern/include" -I"C:/Program Files/MATLAB/R2015aSP1/simulink/include" -I"C:/Program Files/MATLAB/R2015aSP1/rtw/c/src" -I"C:/Program Files/MATLAB/R2015aSP1/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2015aSP1/rtw/c/ert" -I"C:/MATLAB/SupportPackages/R2015aSP1/arduino-1.0.5/hardware/arduino/cores/arduino" -I"C:/MATLAB/SupportPackages/R2015aSP1/arduino-1.0.5/hardware/arduino/variants/standard" -mmcu=atmega328p -ffunction-sections -fdata-sections -std=gnu99 -Wall -Wstrict-prototypes -g -Os -D"MODEL=Calibration_procedure" -D"NUMST=2" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=1" -D"F_CPU=16000000" -D"ARDUINO=105" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"_RTT_NUMSERVOS_=3"
...
POSTBUILD_ARGS := -O ihex -R .eeprom $(TARGET)  Calibration_procedure.hex

EXECUTE_ARGS := 



COMPILER ?= $(subst \,/,C:\MATLAB\SupportPackages\R2015aSP1\arduino-1.0.5\hardware\tools\avr\bin\avr-gcc)

LINKER ?= $(subst \,/,C:\MATLAB\SupportPackages\R2015aSP1\arduino-1.0.5\hardware\tools\avr\bin\avr-gcc)

PREBUILD_TOOL ?= 

POSTBUILD_TOOL ?= $(subst \,/,C:\MATLAB\SupportPackages\R2015aSP1\arduino-1.0.5\hardware\tools\avr\bin\avr-objcopy)
